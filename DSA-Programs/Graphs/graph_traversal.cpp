...
switch(choice)
{
     ...
     case 2: printf("Enter starting node for Depth First Search : ");
             ...
             for(i=1;i<=n;i++)
                 ...
                 dfs(v);
                 break;
     case 3: printf("Enter starting node for Depth First Search : ");
             scanf("%d",&v);
             for(i=1;i<=n;i++)
                  visited[i]=false;
                  dfs_rec(v);
                  break;
     case 4: printf("Enter starting node for Breadth First Search : ");
             scanf("%d", &v);
             for(i=1;i<=n;i++)
             visited[i]=false;
             bfs(v);
             break;
     case 5: printf("Enter node to find adjacent vertices : ");
             scanf("%d", &v);
